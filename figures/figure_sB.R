...
# Figure sB shows the results of the subsampling analysis on insertion sensitivity and precision
...
# Saving the figure as Figure sB
png("figure_sB.png", width = 7, height = 8, units = "in", res = 500)
