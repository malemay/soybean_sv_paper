...
# Figure sC shows the results of the subsampling analysis on duplication sensitivity and precision
...
# Saving the figure as Figure sC
png("figure_sC.png", width = 7, height = 8, units = "in", res = 500)
