...
# Figure sD shows the results of the subsampling analysis on inversion sensitivity and precision
...
# Saving the figure as Figure sD
png("figure_sD.png", width = 7, height = 8, units = "in", res = 500)
