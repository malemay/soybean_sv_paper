...
# Figure S15 shows the proportion of true positive and false positive insertion calls for
...
# Creating the plot
figure_s15 <- ggplot(plotting_data, aes(x = size, fill = truepos)) +
...
png("figure_s15.png", width = 6, height = 6, units = "in", res = 500)
print(figure_s15)
dev.off()
