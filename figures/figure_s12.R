...
# Figure S12 shows the benchmarking of duplications and inversions discovered using Illumina sequencing
...
png("figure_s12.png", width = 3, height = 6, units = "in", res = 500)
grid.newpage()
