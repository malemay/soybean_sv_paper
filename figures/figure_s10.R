...
# Figure S10 shows the benchmarking of SVs discovered using Illumina sequencing
...
# OUTPUT : figure_s10.png
png("figure_s10.png", width = 6, height = 9, units = "in", res = 500)
grid.newpage()
