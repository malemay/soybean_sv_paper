...
# Figure s10 shows the results of the subsampling analysis on inversion sensitivity and precision
...
# Saving the figure as Figure s10
png("figure_s10.png", width = 7, height = 8, units = "in", res = 500)
