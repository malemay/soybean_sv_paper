...
# Figure S20 shows the benchmarking of duplications and inversions discovered using Oxford Nanopore sequencing
...
# Saving to disk as "figure_s20.png"
# OUTPUT : figures/figure_s20.png
png("figure_s20.png", width = 3, height = 6, units = "in", res = 500)
grid.newpage()
