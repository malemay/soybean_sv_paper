...
# Figure S2 shows the benchmarking of SVs discovered using Illumina sequencing
...
# OUTPUT : figures/figure_s2.png
png("figure_s2.png", width = 6, height = 9, units = "in", res = 500)
grid.newpage()
