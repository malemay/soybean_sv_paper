...
% Figure S17 \caption[Population structure analyses of the whole Canadian soybean panel]{{{{
\begin{cfigure}
	% DEPENDENCY : figure_s17.png
	\includegraphics[width = 6.5in]{figure_s17}

	\caption[Population structure analyses of the whole Canadian soybean panel]{
		Population structure analyses of the whole Canadian soybean panel. 
		...
		Samples are colored according to their population assignment by fastStructure based on the population with the highest q-value for each sample. 
		A subset of the Illumina SNVs were used by fastStructure to infer the populations. 
		Samples with a maximum q-value below 0.6 are considered admixed and are labeled with asterisks.
	}
