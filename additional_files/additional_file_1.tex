...
Figure \ref{fig_s19} shows the benchmarking results obtained for BayesTyper.
...
Figure \ref{fig_s20} shows the benchmarking results obtained for vg.
...
Figure \ref{fig_s21} shows the benchmarking results obtained for Paragraph.
...
Results of the subsampling analyses are presented in figure \ref{fig_sA} (deletions), figure \ref{fig_sB} (insertions), figure \ref{fig_sC} (duplications) and figure \ref{fig_sD} (inversions).
...
The results obtained for deletions (figure \ref{fig_sA}) show that sensitivity reaches 80\% at a sequencing depth of 10X across all size classes.
...
The results obtained for insertions (figure \ref{fig_sB}) show that sensitivity reaches 75\% at a sequencing depth of 10X for insertions in the range 50 - 1,000 bp but decreases for larger insertions.
...
The results obtained for duplications (figure \ref{fig_sC}) show that duplication discovery is more sensitive to sequencing depth than other SV types, with sensitivity below 50\% at a sequencing depth of 10X.
...
This result is also consistent with our observation that the precision of duplication genotyping depends strongly on Oxford Nanopore sequencing depth (see figure \ref{fig_s4}).
The precision of duplication discovery seen in figure \ref{fig_sC} is also poor, consistenly with difficulties in discovering and genotyping duplications documented elsewhere in this paper.

Finally, the results obtained for inversions (figure \ref{fig_sD}) show sensitivity values intermediate between those observed for insertions and duplications, with sensitivity reaching between 50 and 75\% at a sequencing depth of 10X.
...
% Figure Y \caption[Graphical summary of the methods used in this paper]{{{{
\begin{lsfigure}
	% DEPENDENCY : Figure_Y.png
	\includegraphics[width = 8.5in]{Figure_y}
...
% Figure sA \caption[Effects of sequencing depth on the sensitivity and precision of deletion discovery from Oxford Nanopore sequencing data]{{{{
\begin{cfigure}
	% DEPENDENCY : figure_sA.png
	\includegraphics[width = 6.2in]{figure_sA}
...
% Figure sB \caption[Effects of sequencing depth on the sensitivity and precision of insertion discovery from Oxford Nanopore sequencing data]{{{{
\begin{cfigure}
	% DEPENDENCY : figure_sB.png
	\includegraphics[width = 6.2in]{figure_sB}
...
% Figure sC \caption[Effects of sequencing depth on the sensitivity and precision of duplication discovery from Oxford Nanopore sequencing data]{{{{
\begin{cfigure}
	% DEPENDENCY : figure_sC.png
	\includegraphics[width = 6.2in]{figure_sC}
...
% Figure sD \caption[Effects of sequencing depth on the sensitivity and precision of inversion discovery from Oxford Nanopore sequencing data]{{{{
\begin{cfigure}
	% DEPENDENCY : figure_sD.png
	\includegraphics[width = 6.2in]{figure_sD}
...
% Figure S17 \caption[Principal component analyses (PCA) of the whole Canadian soybean panel]{{{{
\begin{cfigure}
	% DEPENDENCY : figure_s17.png
	\includegraphics[width = 6.5in]{figure_s17}
...
% Figure sE \caption[Neighbour-joining phylogenetic trees of the population of 102 Canadian soybean cultivars]{{{{
\begin{lsfigure}
	% DEPENDENCY : figure_sE.png
	\includegraphics[width = 9.5in]{figure_sE}
...
% Figure S18 \caption[IGV screenshot of Oxford Nanopore and Illumina read alignments of three samples at the location of a polymorphic Stowaway TE insertion]{{{
\begin{lsfigure}
...
% Figure S19 \caption[Genotyping benchmark of raw and refined Oxford Nanopore SVs for four samples using BayesTyper]{{{
\begin{lsfigure}
...
% Figure S20 \caption[Genotyping sensitivity of raw and refined Oxford Nanopore SVs for four samples using vg]{{{{
\begin{lsfigure}
...
% Figure S21 \caption[Genotyping sensitivity of raw and refined Oxford Nanopore SVs for four samples using Paragraph]{{{
\begin{lsfigure}
