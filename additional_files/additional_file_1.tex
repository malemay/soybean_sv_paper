...
% Figure S17 \caption[Population structure analyses of the whole 102 Canadian soybean panel]{{{{
\begin{cfigure}
	% DEPENDENCY : figure_s17.png
	\includegraphics[width = 6.5in]{figure_s17}

	\caption[Population structure analyses of the whole 102 Canadian soybean panel]{
		Population structure analyses of the whole 102 Canadian soybean panel. 
