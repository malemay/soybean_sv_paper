	...
	\begin{threeparttable}\small
		...
		table foot = \bottomrule]%
			...
			{\type & \ref & (\refprop) & \refmb & (\refmbprop) & & \DEL & (\DELprop) & \DELkb & (\DELkbprop) & & \INS & (\INSprop) & \INSkb & (\INSkbprop) \arraybackslash}
			   ...
			   \item[ ] REF: reference, DEL: deletions, INS: insertions
			   \item[a] Transposable elements $\geq$ 100 bp in the reference genome
			   \item[b] \textit N: Number of reference elements, deletions or insertions matching given TE type %(\% of matching SVs corresponding to a given TE type)
