...
# Collecting the data on SV counts per SVTYPE and SVLEN in order to generate Table S1
...
do
	...
	printf "$i " >> table_s1_data.txt
	../scripts/count_svtypes_svsizes.awk $sample >> table_s1_data.txt
done
