...
# Supplemental figures S1 to S28 (figures S1 and S25 depend on files not generated by code)
SUPFIGURES := $(shell seq 2 28 | xargs -I {} echo figures/figure_s{}.png | grep -v s25) figures/Gm04_2257090_annotated.png figures/figure_s1_diagram.png 

# Supplemental tables S1 to S10
SUPTABLES := $(shell seq 1 10 | xargs -I {} echo tables/table_s{}.csv)
...
figures/figure_s6.png : depth_distributions/average_depth.RData utilities/line_ids.txt \
...
figures/figure_s10.png : nanopore_sv_calling/subsampling_analysis/benchmark_data.RData
...
figures/figure_s12.png : sv_genotyping/illumina_svs/sveval_benchmarks/frequency_RData/sveval_frequency_rates.RData scripts/make_plot_data.R
figures/figure_s13.png : sv_genotyping/illumina_svs/sveval_benchmarks/NCALLERS_ILLUMINA_BENCHMARK scripts/make_plot_data.R
figures/figure_s14.png : sv_genotyping/illumina_svs/size_distribution.tsv
figures/figure_s15.png : sv_genotyping/illumina_svs/sveval_benchmarks/NCALLERS_ILLUMINA_BENCHMARK scripts/format_sveval_plotting_data.R
figures/figure_s16.png : sv_genotyping/illumina_svs/sveval_benchmarks/NCALLERS_ILLUMINA_BENCHMARK scripts/format_sveval_plotting_data.R

figures/figure_s17.png : nanoplot_stats/N50_stats.txt utilities/line_ids.txt \
	sv_genotyping/nanopore_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData

figures/figure_s18.png : sv_genotyping/nanopore_svs/sveval_benchmarks/norepeat_RData/sveval_norepeat_rates.RData scripts/make_plot_data.R
figures/figure_s19.png : sv_genotyping/nanopore_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData scripts/make_plot_data.R
figures/figure_s20.png : sv_genotyping/nanopore_svs/sveval_benchmarks/norepeat_RData/sveval_norepeat_rates.RData scripts/make_plot_data.R
figures/figure_s21.png : sv_genotyping/combined_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData scripts/make_plot_data.R
figures/figure_s22.png : sv_genotyping/combined_svs/sveval_benchmarks/norepeat_RData/sveval_norepeat_rates.RData scripts/make_plot_data.R

figures/figure_s23.png : structure_analysis/snp_pca/SNP_PCA structure_analysis/sv_pca/SV_PCA structure_analysis/structure.5.meanQ

figures/figure_s24.png : structure_analysis/trees/snp_outtree structure_analysis/trees/sv_outtree \
	structure_analysis/trees/SNP_BOOTSTRAP structure_analysis/trees/SV_BOOTSTRAP \
	structure_analysis/structure.5.meanQ

figures/figure_s26.png : breakpoint_refinement_analysis/raw_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData \
...
figures/figure_s27.png : breakpoint_refinement_analysis/raw_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData \
	breakpoint_refinement_analysis/refined_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData \
	scripts/make_plot_data.R

figures/figure_s28.png : breakpoint_refinement_analysis/raw_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData \
	breakpoint_refinement_analysis/refined_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData \
	scripts/make_plot_data.R
...
# Computing the average sequencing depths used for plotting figure S6
...
# Generating the SV size distributions necessary for figure S14
...
# Generating the Nanoplot N50 data for figure S17
...
##### POPULATION STRUCTURE ANALYSES FOR FIGURE S23
