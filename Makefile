...
# Creating some macros for more readable coding
...
FIGURES = figures/figure_1.png figures/figure_2.png figures/figure_3_circos/figure_3.png figures/figure_4.png figures/figure_5.png
...
tables/table_s1.csv tables/table_s2.csv tables/table_s3.csv: tables/formatting_sup_tables.R
	cd tables; ./formatting_sup_tables.R

tables/table_s4.csv:
	cd tables; ./table_s4.R
...
figures/figure_1.png: figures/figure_1.R
	cd figures; ./figure_1.R

figures/figure_2.png: figures/figure_2.R
	cd figures; ./figure_2.R
...
figures/figure_4.png: figures/figure_4.R
	cd figures; ./figure_4.R

figures/figure_5.png: figures/figure_5.R
	cd figures; ./figure_5.R
