...
# Supplemental figures S1 to S27 (figures S1 and S24 depend on files not generated by code)
SUPFIGURES := $(shell seq 2 27 | xargs -I {} echo figures/figure_s{}.png | grep -v s24) figures/Gm04_2257090_annotated.png figures/figure_s1_diagram.png 
...
figures/figure_s2.png : sv_genotyping/illumina_svs/sveval_benchmarks/norepeat_RData/sveval_norepeat_rates.RData scripts/make_plot_data.R
figures/figure_s3.png : sv_genotyping/illumina_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData scripts/make_plot_data.R
figures/figure_s4.png : sv_genotyping/illumina_svs/sveval_benchmarks/norepeat_RData/sveval_norepeat_rates.RData scripts/make_plot_data.R
...
figures/figure_s12.png : sv_genotyping/illumina_svs/sveval_benchmarks/NCALLERS_ILLUMINA_BENCHMARK scripts/make_plot_data.R
figures/figure_s13.png : sv_genotyping/illumina_svs/size_distribution.tsv
figures/figure_s14.png : sv_genotyping/illumina_svs/sveval_benchmarks/NCALLERS_ILLUMINA_BENCHMARK scripts/format_sveval_plotting_data.R
...
figures/figure_s16.png : nanoplot_stats/N50_stats.txt utilities/line_ids.txt \
	sv_genotyping/nanopore_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData

figures/figure_s17.png : sv_genotyping/nanopore_svs/sveval_benchmarks/norepeat_RData/sveval_norepeat_rates.RData scripts/make_plot_data.R
figures/figure_s18.png : sv_genotyping/nanopore_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData scripts/make_plot_data.R
figures/figure_s19.png : sv_genotyping/nanopore_svs/sveval_benchmarks/norepeat_RData/sveval_norepeat_rates.RData scripts/make_plot_data.R
figures/figure_s20.png : sv_genotyping/combined_svs/sveval_benchmarks/nogeno_RData/sveval_nogeno_rates.RData scripts/make_plot_data.R
figures/figure_s21.png : sv_genotyping/combined_svs/sveval_benchmarks/norepeat_RData/sveval_norepeat_rates.RData scripts/make_plot_data.R
...
# Generating the SV size distributions necessary for figure S13
...
# Generating the Nanoplot N50 data for figure S16
