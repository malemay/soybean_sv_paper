...
# DEPENDENCY : VCF files of combined Illumina/Oxford Nanopore SVs genotyped by Paragraph
...
$bcftools merge -Ov $(ls CAD1???_results/sorted_genotypes.vcf.gz) > combined_paragraph_merged.vcf
