...
# Both output vcf files will be used to genotype the whole population of 102 lines
# The one that yields the best benchmarks will be used for the final analyses

# The code will be written into a function to make things clearer even though I expect
...
select_svs(svmerge_file = "svmerged_preliminary.clustered.vcf", input_illumina = "illumina_svs.vcf", 
